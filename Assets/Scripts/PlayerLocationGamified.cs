...
public class PlayerLocationGamified : MonoBehaviour
{
    enum TrackingMode
    {
        Idle,
    ...
    [SerializeField] GameObject _catchButtonGameObject;
    ...
    void Start()
    {
        _catchButtonGameObject.SetActive(false);

        _targetCoords = new Vector2(49.41399f, 8.65110f);
        _targetTextFieldLat.text = _targetCoords.x.ToString();
        _targetTextFieldLong.text = _targetCoords.y.ToString();
    ...
    // Dumme Positionsfunktionen um per Button die Positionen zu wechseln
    public void SetPos1()
    {
    ...
    public void SetPos2()
    {
        SetMockPlayerPos(49.414239f, 8.45092f);
    }
    ...
    //SRH Eingangstür
    public void SetCreatePos1()
    {
        SetTargetCoords(49.41399f, 8.65110f);
    }

    //arc 201
    public void SetCreatePos2()
    {
        SetTargetCoords(49.378880f, 8.675310f);
    }


    //Bahnhof HD Kirchheim
    public void SetCreatePos3()
    {
        //49.378880, 8.675310
        SetTargetCoords(49.38161f, 8.670139f);
    }
    ...
    void UpdateDistance()
    {
        ...
        if (distance < 2f)
            _catchButtonGameObject.SetActive(true);
        else
            _catchButtonGameObject.SetActive(false);
